...
🔗 **Live Demo:** [https://smart-expense-tracker-two-rosy.vercel.app/](https://smart-expense-tracker-two-rosy.vercel.app/)
...
💾 **Local Storage Persistence** – No backend required—data is saved directly in the browser for offline use.
🎨 **Responsive UI** – Clean, modern design using Poppins font, CSS Grid layout, and mobile-friendly styling.
